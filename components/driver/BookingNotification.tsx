...
import { FiClock, FiMapPin, FiDollarSign, FiUser, FiX } from 'react-icons/fi';
        ...
        <div className="p-4">
          ...
          <div className="space-y-3 mb-4">
            <div className="flex items-center space-x-3">
              <FiMapPin className="h-5 w-5 text-green-600 flex-shrink-0" />
            ...
            <div className="flex items-center space-x-3">
              <FiMapPin className="h-5 w-5 text-red-600 flex-shrink-0" />
              <div className="flex-1">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">${request.fare.toFixed(2)}</p>
              </div>
            </div>
          </div>
