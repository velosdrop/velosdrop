...
• What items are being delivered, weight and size etc`}
          ...
          <div className="flex space-x-4 pt-6">
            ...
            <button
              type="submit"
              className="flex-1 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-bold py-3 px-6 rounded-xl shadow-2xl shadow-purple-900/40 hover:shadow-purple-900/60 transition-all duration-300"
            >
              Confirm Delivery
            </button>
          </div>
